...
define(["Instruction", "Stack"], function(Instruction, stack){
...
yy: {},
symbols_: {"error":2,"expressions":3,"instruction":4,"EOF":5,"R_TYPE":6,"REG":7,",":8,"R_TYPEF":9,"I_TYPE":10,"OFFSET":11,"(":12,")":13,"I_TYPEF":14,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"R_TYPE",7:"REG",8:",",9:"R_TYPEF",10:"I_TYPE",11:"OFFSET",12:"(",13:")",14:"I_TYPEF"},
productions_: [0,[3,2],[4,6],[4,6],[4,7],[4,7]],
...
case 2:
            var instructionId = "s" + instructionCounter,
                string = $$.join(" "),
                RType = new Instruction(instructionId, $$[$0-4], [$$[$0-2],$$[$0]], string, "arith_int");
...
case 3:
    var instructionId = "s" + instructionCounter,
                string = $$.join(" "),
                RTypeF = new Instruction(instructionId, $$[$0-4], [$$[$0-2],$$[$0]], string, "arith_float");

            stack.addInstruction(RTypeF);
...
case 4:
    var instructionId = "s" + instructionCounter,
                string = $$.join(" "),
                IType = new Instruction(instructionId, $$[$0-5], $$[$0-1], string, "mem_int");

            stack.addInstruction(IType);
...
case 5:
    var instructionId = "s" + instructionCounter,
                string = $$.join(" "),
                ITypeF = new Instruction(instructionId, $$[$0-5], $$[$0-1], string, "mem_float");
            
            stack.addInstruction(ITypeF);

            instructionCounter++;
break;
}
},
table: [{3:1,4:2,6:[1,3],9:[1,4],10:[1,5],14:[1,6]},{1:[3]},{5:[1,7]},{7:[1,8]},{7:[1,9]},{7:[1,10]},{7:[1,11]},{1:[2,1]},{8:[1,12]},{8:[1,13]},{8:[1,14]},{8:[1,15]},{7:[1,16]},{7:[1,17]},{11:[1,18]},{11:[1,19]},{8:[1,20]},{8:[1,21]},{12:[1,22]},{12:[1,23]},{7:[1,24]},{7:[1,25]},{7:[1,26]},{7:[1,27]},{5:[2,2]},{5:[2,3]},{13:[1,28]},{13:[1,29]},{5:[2,4]},{5:[2,5]}],
defaultActions: {7:[2,1],24:[2,2],25:[2,3],28:[2,4],29:[2,5]},
...
rules: [/^(?:[ \t\r\n\s])/,/^(?:((?:\$t|[rR])(?:[12]?[0-9]|3[01]))\b|(\$zero))/,/^(?:-?[0-9]\d*)/,/^(?:\()/,/^(?:\))/,/^(?:,)/,/^(?:ADDF|SUBF|MULF|DIVF\b)/,/^(?:addf|subf|subf|divf\b)/,/^(?:LF|SF\b)/,/^(?:ADD|SUB|MUL|DIV\b)/,/^(?:add|sub|mul|div\b)/,/^(?:LW|SW\b)/,/^(?:$)/,/^(?:.)/],
